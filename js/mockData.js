...
export const MOCK_PROGRAMS = [
  // ── Technology (Non-Elective) ──
  {
    ...
    costRaw: '$100 per unit/year (Yardi: $120/unit/year)',
  ...
  },
  {
    ...
    costRaw: '$18,000 flat annual fee (Yardi properties only)',
  ...
  },
  {
    ...
    costRaw: '$16,800 flat annual fee (OneSite/Pace properties only)',
  ...
  // ── Technology (Elective) ──
  {
    ...
    costRaw: '$80 per unit/month — includes smart lock + thermostat',
  ...
  },
  {
    ...
    costRaw: '$40 per device + $12 per additional device. Special speaker at $117 one-time fee.',
  ...
  },
  {
    ...
    costRaw: '$20.00 per elevator/month',
  ...
  // ── Marketing (Non-Elective) ──
  {
    ...
    costRaw: 'Starting from $6,500/year — Apartments.com + Zillow bundle. Price varies by market.',
  ...
  // ── Marketing (Elective) ──
  {
    id: 'p8', name: 'Streaming Music Licensing', group: 'Marketing', groupId: 'g2',
    costs: { Yardi: 0, OneSite: 0, PaceOneSite: 0 },
    glCodes: { Yardi: '6120', OneSite: '6120', PaceOneSite: '6120' },
    costRaw: 'Tier One: $1.50/unit/month (common areas only). Tier Two: $2.50/unit/month (amenities + hallways). Contact vendor for exact quote.',
    description: 'Licensed background music for common areas and amenity spaces.',
    resourceUrl: '#', required: false,
    costBasis: 'Per Unit/Month', billingFreq: 'Monthly',
    programOwner: 'Lisa Park', priorYearCost: 0,
  },
  {
    id: 'p8b', name: 'Reputation.com Review Management', group: 'Marketing', groupId: 'g2',
    costs: { Yardi: 5400, OneSite: 5400, PaceOneSite: 5400 },
    glCodes: { Yardi: '6121', OneSite: '6121', PaceOneSite: '6121' },
    costRaw: '$5,400 flat annual fee',
  ...
  },
  {
    ...
    glCodes: { Yardi: '6122', OneSite: '6122', PaceOneSite: '6122' },
    costRaw: '$1.25 per parking space/month',
  ...
  // ── Accounting (Non-Elective) ──
  {
    ...
    costRaw: '$50.00 + Applicable Sales Tax *(estimated 5% increase, not yet finalized)',
  ...
  // ── Accounting (Elective) ──
  {
    ...
    costRaw: '$3,000 flat annual — includes unlimited document storage and workflow seats',
  ...
  },
  {
    ...
    costRaw: '$200 per locker/year. Min. 3 lockers. Installation not included.',
